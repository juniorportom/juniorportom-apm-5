...
var routes = [
    ...
    { path: 'line-item-list', component: line_item_list_component_1.LineItemListComponent },
    { path: 'lineItem/detail/:lineNumber', component: line_item_detail_component_1.LineItemDetailComponent },
    { path: 'sales-invoice-list', component: sales_invoice_list_component_1.SalesInvoiceListComponent },
    { path: 'salesInvoice/detail/:id', component: sales_invoice_detail_component_1.SalesInvoiceDetailComponent },
